...
- [NUnit.Console](https://www.nuget.org/packages/NUnit.Console/): The NUnit Console, with key extensions additionally packaged. Also available as an [msi installer](https://github.com/nunit/nunit-console/releases). For msi installer way, remember to add its install location to your environment variable after installing, such as `C:\Program Files (x86)\NUnit.org\nunit-console`.
